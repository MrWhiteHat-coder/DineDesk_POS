...
const CONTACT_EMAIL = 'support@dinedesk.in';
const CONTACT_PHONE_DISPLAY = '+91 98403 93658';
const CONTACT_PHONE_TEL = 'tel:+919840393658';
const STORE_MAILTO = `mailto:${CONTACT_EMAIL}?subject=${encodeURIComponent('DineDesk Store — module enquiry')}`;
    ...
    <section id="store" className="py-16 sm:py-20 lg:py-24" aria-labelledby="store-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="lp-reveal text-center mt-10">
          <a href={STORE_MAILTO} className="lp-btn-primary">
            Explore DineDesk Store
            <ArrowUpRight className="w-4 h-4" aria-hidden="true" />
          </a>
        </div>
        ...
        <div className="grid gap-10 sm:gap-8 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr_1.2fr]">
          ...
          <nav aria-label="Company">
            ...
            <ul className="mt-4 space-y-1">
              ...
              <li>
                <FooterLink href={`mailto:${CONTACT_EMAIL}?subject=${encodeURIComponent('Support request')}`} external>
                  Support
                </FooterLink>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-1">
              ...
              <li>
                <FooterLink href={CONTACT_PHONE_TEL} external>
