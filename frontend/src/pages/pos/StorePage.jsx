...
export default function StorePage() {
  ...
  return (
    <div className="space-y-6">
      {/* Hero Header */}
      <div className="bg-dd-gradient-hero rounded-card p-8 text-white relative overflow-hidden">
            ...
            <Card key={addon.id} className={`relative transition-all hover:shadow-card-hover ${isActive ? 'border-gray-900 ring-1 ring-gray-900/20' : 'border-dd-border'}`}>
              ...
              <CardContent className="p-5">
                <div className="flex items-start gap-3 mb-4">
                  <div className={`w-11 h-11 rounded-card flex items-center justify-center ${isActive ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-600'}`}>
