  ...
  return (
    <div data-testid="branches-page">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button onClick={() => openModal()} className="h-9 px-3 rounded-lg bg-teal-700 hover:bg-teal-800 text-sm" data-testid="add-branch-btn">
      ...
      <Dialog open={showModal} onOpenChange={setShowModal}>
        <DialogContent className="rounded-2xl">
          ...
          <DialogFooter className="gap-2">
            ...
            <Button onClick={handleSave} className="rounded-lg bg-teal-700 hover:bg-teal-800" data-testid="save-branch-btn">
      ...
      <Dialog open={showCredentials} onOpenChange={setShowCredentials}>
        <DialogContent className="rounded-2xl max-w-sm" data-testid="credentials-modal">
          ...
          <Button onClick={() => setShowCredentials(false)} className="w-full rounded-lg bg-teal-700 hover:bg-teal-800" data-testid="close-credentials-btn">
            Done
          </Button>
        </DialogContent>
      </Dialog>
